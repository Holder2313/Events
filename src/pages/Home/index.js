...
const Page = () => { 
  ...
  // Tri des données pour récupérer le dernier évènement
  ...
  return <>
    ...
    <footer className="row">
      <div className="col presta">
        ...
        {/* Vérification que last existe avant d'utiliser EventCard (erreur console disant que les données ci-dessous sont required mais undefined) */}
        {last && 
        <EventCard
          imageSrc={last?.cover}
          title={last?.title}
